...
echo("action=$PHP_SELF?ln=3&option=blog&action=submit>");
echo("<input type=hidden name=MAX_FILE_SIZE value=$max_file_size class=formitem>");
echo("<h3>Insert blog text : </h3><br>");
echo("<textarea rows=5 cols=80 wrap name=text class=formitem></textarea>");
echo("<td><table border=0><tr><td><h3>Pop Up :</h3></td>");
echo("<br><br><td><h3>Insert image if desired : </h3></td></tr>");
...
echo("<br><br><input type=submit value=\"Insert blog item\" class=formitem>");
echo("</form>");
